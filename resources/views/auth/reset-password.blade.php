...
<head>
    ...
    <title>Reset Password - Ranca Upas</title>
    ...
    <div class="relative w-full max-w-md px-4 sm:px-6 py-6 sm:py-0">
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl border border-white/40">
            <div class="text-center mb-6 sm:mb-8">
                ...
                <h2 class="text-2xl sm:text-3xl font-display font-bold text-forest-900 tracking-tight">Reset Password</h2>
                <p class="text-xs sm:text-sm text-forest-500 mt-1 sm:mt-2">Buat password baru untuk akun Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-4 sm:space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" required
                            ...
                            class="appearance-none block w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 bg-gray-100 border border-gray-200 rounded-lg sm:rounded-xl text-sm sm:text-base text-gray-600 cursor-not-allowed">
                    </div>
                </div>

                <!-- Password -->
                <div>
                    <label for="password" class="block text-xs sm:text-sm font-medium text-forest-800 mb-1.5 sm:mb-2">Password Baru</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-xs sm:text-sm font-medium text-forest-800 mb-1.5 sm:mb-2">Konfirmasi Password Baru</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                            <i data-lucide="lock" class="h-4 w-4 sm:h-5 sm:w-5 text-forest-400"></i>
                        </div>
